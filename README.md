<div align="center">
  <img src="src/assets/img/logo.png" alt="LingapLink Logo" width="400"/>
  ...
  <p align="center">
    ...
    <img src="https://img.shields.io/badge/HIPAA-Compliant-red.svg" alt="HIPAA Compliant" />
  </p>
...
graph TB
    ...
    subgraph "Security Layer"
        P[HIPAA Compliance] --> Q[Data Encryption]
        Q --> R[Audit Logging]
        R --> S[Access Control]
    end
```
...
|------------|---------|---------|
| ![React](https://img.shields.io/badge/React-18.3.1-61DAFB?style=flat&logo=react&logoColor=white) | 18.3.1 | Modern UI framework with hooks and context |
| ![TypeScript](https://img.shields.io/badge/TypeScript-5.8.3-3178C6?style=flat&logo=typescript&logoColor=white) | 5.8.3 | Type-safe JavaScript development |
| ![Vite](https://img.shields.io/badge/Vite-6.3.5-646CFF?style=flat&logo=vite&logoColor=white) | 6.3.5 | Fast build tool and development server |
| ![React Router](https://img.shields.io/badge/React_Router-6.24.1-CA4245?style=flat&logo=react-router&logoColor=white) | 6.24.1 | Client-side routing and navigation |
| ![Lucide React](https://img.shields.io/badge/Lucide-0.523.0-000000?style=flat&logo=lucide&logoColor=white) | 0.523.0 | Modern icon library |
| ![Recharts](https://img.shields.io/badge/Recharts-3.0.0-FF6B6B?style=flat&logo=chart.js&logoColor=white) | 3.0.0 | Data visualization and analytics |

### Backend & Services
| Technology | Version | Purpose |
|------------|---------|---------|
| ![Node.js](https://img.shields.io/badge/Node.js-20+-339933?style=flat&logo=node.js&logoColor=white) | 20+ | JavaScript runtime environment |
| ![Express](https://img.shields.io/badge/Express-4.19.2-000000?style=flat&logo=express&logoColor=white) | 4.19.2 | Web application framework |
| ![Firebase](https://img.shields.io/badge/Firebase-11.9.1-FFCA28?style=flat&logo=firebase&logoColor=black) | 11.9.1 | Backend-as-a-Service platform |
| ![Firestore](https://img.shields.io/badge/Firestore-11.9.1-FFCA28?style=flat&logo=firebase&logoColor=black) | 11.9.1 | NoSQL document database |
| ![Google Gemini](https://img.shields.io/badge/Gemini-0.24.1-4285F4?style=flat&logo=google-gemini&logoColor=white) | 0.24.1 | AI/ML services and natural language processing |

### Development & Quality
| Technology | Version | Purpose |
|------------|---------|---------|
| ![ESLint](https://img.shields.io/badge/ESLint-9.29.0-4B32C3?style=flat&logo=eslint&logoColor=white) | 9.29.0 | Code linting and quality assurance |
| ![Prettier](https://img.shields.io/badge/Prettier-3.6.0-F7B93E?style=flat&logo=prettier&logoColor=black) | 3.6.0 | Code formatting and style consistency |
| ![Vitest](https://img.shields.io/badge/Vitest-2.1.8-6E9F18?style=flat&logo=vitest&logoColor=white) | 2.1.8 | Fast unit testing framework |
| ![Testing Library](https://img.shields.io/badge/Testing_Library-16.1.0-E33332?style=flat&logo=testing-library&logoColor=white) | 16.1.0 | React component testing utilities |

### Security & Performance
| Technology | Version | Purpose |
|------------|---------|---------|
| ![Helmet](https://img.shields.io/badge/Helmet-7.1.0-000000?style=flat&logo=helmet&logoColor=white) | 7.1.0 | Security headers and middleware |
| ![JWT](https://img.shields.io/badge/JWT-9.0.2-000000?style=flat&logo=json-web-tokens&logoColor=white) | 9.0.2 | Secure authentication tokens |
| ![Rate Limiting](https://img.shields.io/badge/Rate_Limit-7.1.5-FF6B6B?style=flat&logo=express&logoColor=white) | 7.1.5 | API rate limiting and abuse prevention |
| ![DOMPurify](https://img.shields.io/badge/DOMPurify-3.0.8-000000?style=flat&logo=dompurify&logoColor=white) | 3.0.8 | XSS protection and HTML sanitization |
...
|:---:|:---:|:---:|
| <img src="src/assets/img/Threshia.png" alt="Threshia" width="120" style="border-radius: 50%;"> | <img src="src/assets/img/Francheska.png" alt="Francheska" width="120" style="border-radius: 50%;"> | <img src="src/assets/img/juanito.png" alt="Juanito" width="120" style="border-radius: 50%;"> |
| **Lead Developer** | **UI/UX Designer** | **Backend Engineer** |
| [![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/threshia-saut-b74055316/) | [![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/franchezca-natividad-banayad-25b278261) | [![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/juanito-ramos/) |

| **Maxxinne Lorin M. Fernandez** | **Adriel Magsipoc Magalona** |
|:---:|:---:|
| <img src="src/assets/img/max.png" alt="Maxxinne" width="120" style="border-radius: 50%;"> | <img src="src/assets/img/Adriel.png" alt="Adriel" width="120" style="border-radius: 50%;"> |
| **Security Engineer** | **Full-Stack Developer** |
| [![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/maxxinne-fernandez-364776336/) | [![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/adriel-magalona/) |
