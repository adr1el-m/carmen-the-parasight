// api/controllers/authController.js - Converted to ES Module syntax
...
export const registerUser = async (req, res) => { // IMPORTANT: Add export
...
export const loginUser = async (req, res) => { // IMPORTANT: Add export
